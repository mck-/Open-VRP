...
(defvar test-tsp (define-problem "test-case-TSP" *node-coords* 1 "plots/test-tsp.png"))
(defvar test-vrp (define-problem "test-case-VRP" *node-coords* 2 "plots/test-vrp.png"))
