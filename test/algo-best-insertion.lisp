...
(define-test generate-insertion-moves
  ...
  (let* ((o1 (make-order :node-id :o1))
         ...
         (t1 (make-vehicle :id :t1 :route (list o1 o2 o3 o4)))
         (dist {:o1 {      :o2 1 :o3 2 :o4 3 :o5 5}
                :o2 {:o1 1       :o3 1 :o4 2 :o5 4}
                :o3 {:o1 2 :o2 1       :o4 1 :o5 3}
                :o4 {:o1 3 :o2 2 :o3 1       :o5 1}
                :o5 {:o1 4 :o2 3 :o3 2 :o4 1      }})
