...
(define-test distance
  ...
  (let ((matrix (alist-to-hash '((:a (:b . 1) (:c . 2)) (:b (:a . 3) (:c . 5)) (:c (:a . 8) (:b . 2))))))
    ...
    (assert-error 'expect-keyword-arguments (distance "c" "a" matrix))
    (assert-error 'expect-hash-table (distance :a :c '((:a (:c . 2)))))
    (assert-error 'expect-hash-table (distance :d :c matrix))))
